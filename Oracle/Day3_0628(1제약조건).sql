...
-- 제약 조건 4) check : 컬럼값의 범위를 설정 >> age 컬럼값은 16~80, null 허용합니다
ALTER TABLE tbl2# ADD age number(3) CHECK (age BETWEEN 16 AND 80);
INSERT INTO tbl2#(tno,tid,age) VALUES (222,123,20);
INSERT INTO tbl2#(tno,tid,age) VALUES (223,124,90);		-- 오류 :체크 제약조건이 위배되었습니다
--		성별 gender 컬럼 추가
...
INSERT INTO "TBL2#" (tno,gender) VALUES (246,'m');		--오류 : CHECK 제약조건 위반
