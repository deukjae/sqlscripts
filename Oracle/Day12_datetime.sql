 ...
 * 
 * 일반적으로는 date와 timestmap을 표시하는 방법은 동일합니다
 */
...
VALUES ('2022-10-11','2022-10-12');				-- DATE,timestemp 차이가 없습니다.

-- 내일 시험에서 timestemp 타입은 date 타입과 똑같이 처리하면 됩니다.
-- 날짜형식은 문자열 'yyyy-MM-dd' 과 자동캐스팅이 됩니다
-- date와 timestemp 모두 to_char 함수는 동일하게 사용합니다.
